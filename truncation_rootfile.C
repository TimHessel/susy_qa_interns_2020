...
void truncation_rootfile(){
  ...
  {"(Jet1Pt<1000)&&(Met<920)&&(mt<210)&&(LepPt<78)&&(HT<1600)&&(JetHBpt<800)&&(DrJetHBLep<4.8)&&(DrJetHBLep>0)&&(JetHBCSV>0.045)&&(LepEta>-2.4)", //Stop_250_220
	"(Jet1Pt<1000)&&(Met<1050)&&(mt<228)&&(LepPt<72)&&(HT<1550)&&(JetHBpt<900)&&(DrJetHBLep<4.8)&&(DrJetHBLep>0.008)&&(JetHBCSV>0.04)&&(LepEta>-2.4)", //Stop_275_245
  ...
  "(Jet1Pt<1050)&&(Met<1125)&&(mt<195)&&(LepPt<43)&&(HT<1375)&&(JetHBpt<820)&&(DrJetHBLep<4.5)&&(DrJetHBLep>0.4)&&(JetHBCSV>0.045)&&(LepEta>-2.4)&&(LepEta<2.3)", //Stop_550_520
  "(Jet1Pt<1050)&&(Met<1125)&&(mt<195)&&(LepPt<43)&&(HT<1375)&&(JetHBpt<820)&&(DrJetHBLep<4.3)&&(DrJetHBLep>0.1)&&(JetHBCSV>0.0575)&&(LepEta>-2.4)&&(LepEta<2.3)", //Stop_575_545
  "(Jet1Pt<1000)&&(Met<1150)&&(mt<250)&&(LepPt<45)&&(HT<1300)&&(JetHBpt<950)&&(DrJetHBLep<4.4)&&(DrJetHBLep>0.2)&&(JetHBCSV>0.04)&&(LepEta>-2.3)&&(LepEta<2)", //Stop_600_570
  "(Jet1Pt<1100)&&(Met<1200)&&(mt<250)&&(LepPt<38)&&(HT<1700)&&(JetHBpt<800)&&(DrJetHBLep<4.2)&&(DrJetHBLep>0.3)&&(JetHBCSV>0)&&(LepEta>-2.2)&&(LepEta<2)", //Stop_625_595
  "(Jet1Pt<975)&&(Met<1100)&&(mt<260)&&(LepPt<40)&&(HT<1600)&&(JetHBpt<975)&&(DrJetHBLep<4)&&(DrJetHBLep>0.2)&&(JetHBCSV>0)&&(LepEta>-2.3)&&(LepEta<2)", //Stop_650_620
  "(Jet1Pt<950)&&(Met<1150)&&(mt<250)&&(LepPt<46)&&(HT<1350)&&(JetHBpt<1025)&&(DrJetHBLep<4)&&(DrJetHBLep>0.2)&&(JetHBCSV>0)&&(LepEta>-2.1)&&(LepEta<1.7)", //Stop_675_645
  "(Jet1Pt<1000)&&(Met<1250)&&(mt<250)&&(LepPt<42)&&(HT<1550)&&(JetHBpt<830)&&(DrJetHBLep<4.2)&&(DrJetHBLep>0.3)&&(JetHBCSV>0.04)&&(LepEta>-2)&&(LepEta<1.7)", //Stop_700_670
