...
name="/home/t3cms/thessel/Workflow2/stop_data/stop_test_sig_wc_AB.csv"
name_bkg="/home/t3cms/thessel/Workflow2/stop_data/stop_test_bkg_wc_AB.csv"
drop_cols=[0,1,2,15]
...
final_df.iloc[:cut].to_csv("pca_stop_test_sig_wc_AB.csv",header= False,index=False)
final_df.iloc[cut:].to_csv("pca_stop_test_bkg_wc_AB.csv",header= False , index =False)
